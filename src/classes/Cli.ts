...
class Cli {
 // DONE: update the vehicles property to accept Truck and Motorbike objects as well 
  ...
  constructor(vehicles: (Car | Truck | Motorbike)[], selectedVehicleVin: string | undefined, exit: boolean = false) {
      ...
      .prompt([
        {
          ...
          choices: this.vehicles.map((vehicle: Truck | Car | Motorbike) => {
            return {
