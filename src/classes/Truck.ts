...
class Truck extends Vehicle implements AbleToTow {
  ...
  constructor(started: boolean, currentSpeed: number, vin: string, color:string, make: string, model: string, year: number, weight: number, topSpeed: number, wheels: Wheel[] = [defaultWheel,defaultWheel,defaultWheel,defaultWheel], towingCapacity: number) {
