...
class Cli {
    ...
    constructor(vehicles, selectedVehicleVin, exit = false) {
    ...
    createCar() {
        inquirer
            ...
            answers.started, parseInt(answers.currentSpeed), Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), []);
    ...
    createTruck() {
        inquirer
            ...
            const truck = new Truck(answers.started, parseInt(answers.currentSpeed), Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [], parseInt(answers.towingCapacity));
    ...
    createMotorbike() {
        inquirer
            ...
            const motorbike = new Motorbike(answers.started, parseInt(answers.currentSpeed), Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [
